...
window.customElements.define('game-chart', _chart.GameChart);

var chartDOM = document.querySelector('game-chart');
...
var BufferQueue = exports.BufferQueue = function () {
    function BufferQueue(size) {
        _classCallCheck(this, BufferQueue);

        this.memory = [];
        this.size = size;
    }

    _createClass(BufferQueue, [{
        key: "push",
...
var GameChart = exports.GameChart = function (_HTMLElement) {
    _inherits(GameChart, _HTMLElement);

    function GameChart() {
        _classCallCheck(this, GameChart);

        var _this = _possibleConstructorReturn(this, (GameChart.__proto__ || Object.getPrototypeOf(GameChart)).call(this));

        _this._values = [];
        _this._color = '#ff0000';
        _this._displayStyle = 'horizontal';
        return _this;
    }

    _createClass(GameChart, [{
        ...
        value: function connectedCallback() {
            ...
            ['color', 'values', 'displayStyle'].forEach(function (p) {
                _this2._upgradeProperty(p);
            });
...
function tick(callback) {
    ...
    // TODO: schedule another tick call in TICK_INTERVAL
    // hint: check game.js in homework
    setTimeout(tick.bind(this, callback), 1000);
}
